	...
	public static void main(String[] args) {
		...
		while (true) {
					...
					if (n1==1) {
						...
						if (userInfoBean1 != null) {
							...
							if (cs==1) {
								...
								/*
								 * System.out.println("Enter item to cart t_Id"); int t_Id = sc.nextInt();
								 */
								...
								medicalInfoBean1 = new MedicalInfoBean1();
								medicalInfoBean1.setEmail(email);
								medicalInfoBean1.setTab_Name(tab_Name);
								medicalInfoBean1.setTab_Qty(tab_Qty);
								medicalInfoBean1.setTab_Price(tab_Price);
								...
								if (dao.addCart(medicalInfoBean1)) {
									...
									if (cs1==1) {
										...
										medicalInfoBean1 = new MedicalInfoBean1();
										medicalInfoBean1.setEmail(email1);
			...
			case 3:
				...
				System.out.println("Wish to Continue 1.SignUp Here\n 2.Exit");
				int sign = sc.nextInt();
				if (sign==1) {
